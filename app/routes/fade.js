...
exports.invoke = function(req, res) {
  ...
  substitutionModel = postdata.substitutionModel;

  FADE.mail = postdata.mail;

  Msa.parseFile(fn, datatype, gencodeid, substitutionModel, function(err, msa) {
    if (err) {
    ...
    // TODO: setup FADE max-sites and max-sequences.
