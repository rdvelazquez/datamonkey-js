...
exports.uploadFile = function(req, res) {
  ...
  msa.substitutionModel = data.substitutionModel;
  msa.gencodeid = PROTEIN_GENCODE;

  console.log("substitutionModel: ", msa.substitutionModel);
  fade.mail = postdata.mail;

  msa.dataReader(fn, msa.substituionModel, function(err, result) {
    if (err) {
      logger.error(err);
