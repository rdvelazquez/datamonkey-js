...
var GARDForm = React.createClass({
  ...
  submit: function(e) {
    ...
    formData.append(
      ...
      $("select[name='site_to_site_variation']").val()
    );
      ...
      >
        ...
        <div className="upload-div">
          <label id="datatype-content">
            Data Type
            <a href="/help#data-types" target="_blank">
              <sup>?</sup>
            </a>
          </label>
        ...
        <div className="upload-div">
          ...
          <select name="site_to_site_variation">
            ...
            <option value="general_discrete">General Discrete</option>
            <option value="beta_gamma">Beta-Gamma</option>
          </select>
        </div>
